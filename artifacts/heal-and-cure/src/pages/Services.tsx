...
const homeopathyServices = [
  ...
  { icon: Activity, title: "Hypertension Management", desc: "Evidence-based homoeopathic care for hypertension and blood pressure disorders, with published RCT evidence supporting treatment efficacy.", cat: "homoeopathy" as const },
