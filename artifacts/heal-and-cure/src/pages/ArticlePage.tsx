...
const articles: Record<string, Article> = {
  "homeopathy-for-diabetes": {
    ...
    faq: [
      ...
      { q: "Is homoeopathy safe for diabetic patients on insulin?", a: "Yes. Homoeopathic remedies do not interact with insulin or other diabetes medications. They are safe to take alongside your prescribed treatment." },
  ...
  "constitutional-homeopathic-treatment": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "A constitutional case-taking at Heal & Cure is a detailed, unhurried conversation — typically lasting 30 to 40 minutes for an initial consultation. Dr. Souvik Dutta will explore your chief complaints in detail, but will also ask about aspects of your health and personality that may seem unrelated to your presenting condition. These include your thermal sensibility (are you predominantly chilly or warm?), your food desires and aversions, your sleep position and patterns, your emotional make-up, your response to stress and grief, your dreams, your energy patterns throughout the day, and the family history of disease. All of these factors contribute to the constitutional picture — the unique symptom constellation that, when matched to a homoeopathic remedy, produces the most healing response. This process is not a questionnaire exercise. It is a genuine clinical interview requiring skill, patience, and deep knowledge of homoeopathic Materia Medica."
      },
      {
