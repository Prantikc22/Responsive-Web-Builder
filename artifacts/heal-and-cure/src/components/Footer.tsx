        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-3">
              <img src={logoImg} alt="Heal & Cure Health Clinic" className="h-16 w-auto object-contain"/>
              <div className="flex flex-col leading-tight">
                <span className="font-serif text-xl text-[var(--gold)] font-semibold leading-none">Heal &amp; Cure</span>
                <span className="font-sans text-[10px] text-gray-400 uppercase tracking-[0.18em] mt-1">Health Clinic</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.facebook.com/thehchc.drsouvik" target="_blank" rel="noopener noreferrer"
                ...
                data-testid="link-facebook" aria-label="Heal & Cure on Facebook">
          ...
          {/* Col 2: Treatments */}
          <div>
            <h4 className="font-serif text-lg text-[var(--gold)] mb-5">Our Treatments</h4>
            <ul className="flex flex-col gap-3 text-sm text-gray-400">
              {[
                "Classical Homoeopathy",
                "Therapeutic Diet Counselling",
                "Diabetes Management",
                "Weight Management (Diet Only)",
                "Hormonal & Thyroid Care",
          ...
          <div>
              ...
              <li>
                ...
                <div className="flex flex-col gap-1.5">
                  <a href="tel:+918961661727" className="flex items-center gap-2 hover:text-white transition-colors">
                    <Phone className="w-3.5 h-3.5 text-[var(--gold)] shrink-0"/> +91 8961661727 <span className="text-gray-600 text-xs">(appointments)</span>
                  </a>
                  <a href="tel:+917980219737" className="flex items-center gap-2 hover:text-white transition-colors">
                    <AlertCircle className="w-3.5 h-3.5 text-amber-400/70 shrink-0"/> +91 7980219737 <span className="text-gray-600 text-xs">(emergency)</span>
                  </a>
                </div>
              </li>

              <li>
                <p className="text-[var(--gold)]/70 text-[10px] uppercase tracking-wider font-sans font-semibold mb-2">Mrs. Pampita Banerjee</p>
                <a href="tel:+918961661727" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Phone className="w-3.5 h-3.5 text-[var(--gold)] shrink-0"/> +91 8961661727
                </a>
              </li>
            ...
            <div className="mt-5 bg-white/5 rounded-xl p-4 border border-white/8">
              ...
              <p className="text-xs text-gray-500 mt-1">Pampita &nbsp;·&nbsp; Online, all days (24 hrs prior booking)</p>
            </div>
          </div>
        </div>
