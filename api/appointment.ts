      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:36px 40px;">
          ...
          <div style="border:1px solid #e8e2d8;border-radius:10px;padding:20px 24px;margin-bottom:24px;">
            ...
            <p style="margin:0 0 8px;color:#374151;font-size:13px;line-height:1.6;">✅ &nbsp;Our team will call or WhatsApp you at <strong>${phone}</strong> to confirm the appointment slot.</p>
            <p style="margin:0 0 8px;color:#374151;font-size:13px;line-height:1.6;">📅 &nbsp;For online consultations, please book at least <strong>24 hours in advance</strong>.</p>
            <p style="margin:0;color:#374151;font-size:13px;line-height:1.6;">💬 &nbsp;You can also reach us on WhatsApp at <strong>+91 8961661727</strong> for any queries.</p>
          </div>
